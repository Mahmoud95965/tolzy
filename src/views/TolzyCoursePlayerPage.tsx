    ...
    const fetchRealStudentCount = async () => {
        ...
        try {
            ...
            if (response.data && response.data.studentsCount > 0) {
                ...
                // 2. Persist moved to Server Side (@api/fetch-course) to avoid permission errors
        ...
        <PageLayout>
            ...
            <div className="min-h-screen bg-[#FDFDFD] dark:bg-[#050505] font-sans text-gray-900 dark:text-gray-300 relative overflow-x-hidden selection:bg-indigo-500/30 transition-colors duration-300" dir="rtl">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 relative z-10">
                    ...
                    {/* Header - Moved outside grid for Mobile Optimization */}
                    <div className="mb-8 lg:mb-12">
                        ...
                        <h1 className="text-4xl md:text-6xl font-black text-gray-900 dark:text-white leading-[1.15] tracking-tight mb-6">
                            {course.title}
                        </h1>
                        <p className="text-lg md:text-xl text-gray-600 dark:text-gray-400 leading-relaxed font-light max-w-3xl">
                            {course.description}
                        </p>
                    </div>

                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 items-start">
                        {/* Right Column: Sticky Card - Mobile First */}
                        <motion.div
                            initial={{ opacity: 0, y: 20 }}
                            animate={{ opacity: 1, y: 0 }}
                            transition={{ delay: 0.2 }}
                            className="lg:col-span-5 lg:sticky lg:top-24 order-first lg:order-last mb-8 lg:mb-0"
                        >
                        ...
                        <motion.div
                            ...
                            className="lg:col-span-7 space-y-10 order-last lg:order-first"
                        >
                            ...
                            {/* Reviews Section */}
                            <div id="reviews-section" className="pt-6 border-t border-gray-100 dark:border-white/5">
                                <CourseReviews
                                    courseId={course.id}
