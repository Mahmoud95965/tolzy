...
exports.aggregateToolVotes = void 0;
 ...
 */
exports.aggregateToolVotes = (0, firestore_1.onDocumentWritten)("tools/{toolId}/votes/{userId}", async (event) => {
    ...
    await db.runTransaction(async (transaction) => {
        ...
        votesSnapshot.forEach(doc => {
            const data = doc.data();
            if (data.voteType === "helpful")
                helpfulCount++;
            if (data.voteType === "notHelpful")
                notHelpfulCount++;
        });
